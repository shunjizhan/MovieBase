...
def sanitize(text):
    ...
    for index, word in enumerate(splitted_text):
        ...
        elif word[-1] in [',', '.', ';', '?', ':', '!'] and len(word) > 1 and word[0] not in [',', '.', ';', '?', ':', '!']:
    ...
    for i in range( len(splitted_text) -1):
        if (not splitted_text[i] in [',', '.', ';', '?', ':', '!', '...']) and (not splitted_text[i+1] in [',', '.', ';', '?', ':', '!', '...']):
    ...
    for i in range( len(splitted_text) -2):
        if (not splitted_text[i] in [',', '.', ';', '?', ':', '!', '...']) and (not splitted_text[i+1] in [',', '.', ';', '?', ':', '!', '...']) and (not splitted_text[i+2] in [',', '.', ';', '?', ':', '!', '...']):
